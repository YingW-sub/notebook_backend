...
![welcome_page](./image/welcome.png)
...
#### 📁 模块三：分类管理
自由抽屉体系：拒绝死板的树状结构，支持自由创建“考研复习”、“项目研发”、“生活手记”等个性化分类。
...
📊 模块五：时间精力复盘（可视化仪表盘）
数字分身分析器：通过动态饼图或柱状图，直观呈现各个分类的笔记占比。

复盘价值：一目了然地识别近期的关注重心，帮助你科学分配时间与精力。

🤖 模块六：AI 深度赋能（系统的灵魂）
我们通过大模型（支持 DeepSeek / 通义千问 / Kimi）将 AI 切入你的思考流程：
